...
int main()
{
	...
	spotLights[1] = SpotLight(0.0f, 1.0f, 0.0f,
		1.0f, 2.0f,
		5.0f, 1.0f, 0.0f, //POS
		1.0f, 0.0f, 0.0f,//DIRECCION LE PUSO Y POSUTICA
		1.0f, 0.0f, 0.0f, //EC DE SEGUNDO GRADO PARA ATENUAR (LIMITAR) LA ILUMNIACION
	...
	spotLights[2] = SpotLight(0.0f, 0.0f, 1.0f,
		...
		0.001f, 0.05f, 0.01f, //EC DE SEGUNDO GRADO PARA ATENUAR (LIMITAR) LA ILUMNIACION
		15.0f); //ANGULO DE APERTURA
	spotLightCount++;
	...
	pointLights[1] = PointLight(1.0f, 1.0f, 1.0f,
		2.0f, 2.0f, //intensidad ambientak(intensidad) y difusa(saturacion)
	...
	while (!mainWindow.getShouldClose())
	{
		...
		carPosition = glm::vec3(-1.5f + mainWindow.getmuevex(), -0.1f, 0.0f);  // Actualiza la posición del coche
		spotLights[2].SetPos(carPosition);
		
		//LUZ HELICOPTERO
		chappaPosition = glm::vec3( mainWindow.getmuevex2(), 5.0f, 6.0f);  // Actualiza la posición del coche
		spotLights[3].SetPos(chappaPosition);
